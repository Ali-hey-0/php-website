...
?>
    ...
    <body>
      ...
      <div class="container mt-5">
        <a href="registrar-office.php" class="btn btn-dark">بازگشت</a>

        <form method="post" class="shadow p-3 mt-5 form-w" action="req/registrar-office-add.php">
          <h3>افزودن دفتر ثبت کاربر</h3>
          <hr>
          ...
          <?php } ?>
          <div class="mb-3">
            <label class="form-label"> نام خود را وارد کنید</label>
          ...
          <div class="mb-3">
            <label class="form-label"> شماره کارمندی </label>
