      ...
      <body>
        ...
        ?>
          <div class="container mt-5">
            <a href="student-add.php" class="btn btn-dark">افزودن دانش اموز جدید </a>
              ...
              <table class="table table-bordered mt-3 n-table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">ID</th>
                    <th scope="col">نام</th>
                    <th scope="col"> نام خانوادگی خود را وارد کنید</th>
                    <th scope="col">نام کاربری خود را وارد کنید</th>
                  ...
                  foreach ($students as $student) {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="student-delete.php?student_id=<?= $student['student_id'] ?>" class="btn btn-danger">جذف</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
