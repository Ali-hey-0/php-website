...
?>
	...
	<head>
		...
		<title>خوش امدید به <?= $setting['school_name'] ?></title>
		...
		<div class="black-fill"><br /> <br />
			<div class="container">
				<nav class="navbar navbar-expand-lg bg-light" id="homeNav">
					<div class="container-fluid">
						<a class="navbar-brand" href="#">
							<img src="./img/Schools Vector Design Images, School Icon, School Icons, School, Vector PNG Image For Free Download.jfif" width="40">
						</a>
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav me-auto mb-2 mb-lg-0">
								...
								<li class="nav-item">
									<a class="nav-link" href="#contact">ارتباط</a>
								</li>
							</ul>
				...
				<section class="welcome-text d-flex justify-content-center align-items-center flex-column">
					<img src="./img/School building icon in flat style_ College education vector illustration with long shadow. Bank, government business concept_">
					<h4>خوش آمدید به دبیرستان   <?= $setting['school_name'] ?></h4>
					<p><?= $setting['slogan'] ?></p>
				</section>
				<section id="about" class="d-flex justify-content-center align-items-center flex-column">
					<div class="card mb-3 card-1">
						<div class="row g-0">
							...
							<div class="col-md-8">
								<div class="card-body">
									<h5 class="card-title">راجب ما</h5>
									<p class="card-text"><?= $setting['about'] ?></p>
									<p class="card-text"><small class="text-muted"> School</small></p>
								</div>
							</div>
						</div>
					</div>
				...
				<section id="contact" class="d-flex justify-content-center align-items-center flex-column">
					<form method="post" action="req/contact.php">
						...
						<div class="mb-3">
							...
							<div id="emailHelp" class="form-text">آدرس ایمیل شما به اشتراک نخواهد شد .</div>
						</div>
						<div class="mb-3">
							<label class="form-label"> نام و نام خوانوادگی</label>
