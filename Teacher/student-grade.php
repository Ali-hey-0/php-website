            ...
            <form method="post" action="">
              <div class="mb-3">
                <ul class="list-group">
                  ...
                  <li class="list-group-item"><b>نام: </b> <?php echo $student['fname'] ?></li>
                  <li class="list-group-item"><b> نام خانوادگی: </b> <?php echo $student['lname'] ?></li>
                  <li class="list-group-item"><b>نمره : </b>
                    <?php $g = getGradeById($student['grade'], $conn);
                    echo $g['grade_code'] . '-' . $g['grade'];
                    ?>
                  </li>
                  <li class="list-group-item"><b>بخش : </b>
                    <?php $s = getSectioById($student['section'], $conn);
                    echo $s['section'];
                    ?>
                  </li>
                  <li class="list-group-item text-center"><b>سال: </b> <?php echo $setting['current_year']; ?> &nbsp;&nbsp;&nbsp;<b>Semester</b> <?php echo $setting['current_semester']; ?></li>
                </ul>
              </div>
              <h5 class="text-center">افزودن نمره</h5>
                ...
                <?php foreach ($subjects as $subject) {
                  foreach ($teacher_subjects as $teacher_subject) {
                    if ($subject['subject_id'] == $teacher_subject) { ?>
                      ...
                      <option <?php if ($ssubject_id == $subject['subject_id']) {
                                echo "selected";
              ...
              <button type="submit" class="btn btn-primary">انتخاب</button><br><br>
            </form>
