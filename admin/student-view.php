          ...
          <div class="container mt-5">
            <div class="card" style="width: 22rem;">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">نام: <?= $student['fname'] ?></li>
                <li class="list-group-item"> نام خانوادگی: <?= $student['lname'] ?></li>
                <li class="list-group-item">نام کاربری: <?= $student['username'] ?></li>
                ...
                <li class="list-group-item">تاریخ عضویت: <?= $student['date_of_joined'] ?></li>

                <li class="list-group-item">مقطع تحصیلی:
                  <?php
                  $grade = $student['grade'];
                ...
                <br><br>
                <li class="list-group-item"> نام والدین : <?= $student['parent_fname'] ?></li>
                <li class="list-group-item"> نام خانوادگی والدین : <?= $student['parent_lname'] ?></li>
                <li class="list-group-item"> شماره تماس والدین : <?= $student['parent_phone_number'] ?></li>
              </ul>
              <div class="card-body">
