    ...
    <body  >
      ...
      ?>
        <div class="container mt-5">
          <a href="teacher-add.php" class="btn btn-dark">افزودن دبیر جدید</a>
                  ...
                  <tbody>
                    ...
                    foreach ($teachers as $teacher) {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="justify-content-between d-flex " style="width: 150px;">
                            <a href="teacher-edit.php?teacher_id=<?= $teacher['teacher_id'] ?>" class="btn btn-warning">تغییر</a>
                            <a href="teacher-delete.php?teacher_id=<?= $teacher['teacher_id'] ?>" class="btn btn-danger">حذف</a>
                          </div>
                        </td>
                      </tr>
                    <?php } ?>
