          ...
          <div class="container mt-5">
            <div class="card" style="width: 22rem;">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">شماره کاربری: <?= $teacher['employee_number'] ?></li>
                <li class="list-group-item">آدرس: <?= $teacher['address'] ?></li>
                <li class="list-group-item">تاریخ تولد: <?= $teacher['date_of_birth'] ?></li>
                <li class="list-group-item">شماره تماس : <?= $teacher['phone_number'] ?></li>
                ...
                <li class="list-group-item">تاریخ عضویت : <?= $teacher['date_of_joined'] ?></li>
              ...
              <div class="card-body">
                <a href="teacher.php" class="card-link">بازگشت</a>
              </div>
            </div>
          </div>
        <?php
