    ...
    <body>
      ...
      <div class="d-flex justify-content-center align-items-center flex-column">
        <form method="post" class="shadow p-3 my-5 form-w" action="req/teacher-change.php" id="change_password">
          ...
          <div class="mb-3">
            <div class="mb-3">
              <label class="form-label">پسورد قبلی را وارد کنید</label>
              <input type="password" class="form-control" name="old_pass">
            </div>

            <label class="form-label">پسورد جدید را وارد کنید </label>
          ...
          <div class="mb-3">
            <label class="form-label">پسورد خود را تایید کنید </label>
