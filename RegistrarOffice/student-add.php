...
?>
    ...
    <body>
      <div class="container mt-5">
        <a href="index.php" class="btn btn-dark">بازگشت</a>
        ...
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/student-add.php">
          ...
          <div class="mb-3">
            <label class="form-label"> نام خانوادگی خود را وارد کنید</label>
          ...
          <div class="mb-3">
            ...
            <input type="radio" value="Male" checked name="gender"> مرد
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" value="Female" name="gender"> زن
          </div><br>
          <hr>
          <div class="mb-3">
            <label class="form-label">نام کاربری خود را وارد کنید</label>
          ...
          <hr>
          <div class="mb-3">
            <label class="form-label"> نام والدین خود را وارد کنید</label>
            <input type="text" class="form-control" value="<?= $pfn ?>" name="parent_fname">
          </div>
          <div class="mb-3">
            <label class="form-label"> نام خانوادگی والدین خود را وارد کنید</label>
            <input type="text" class="form-control" value="<?= $pln ?>" name="parent_lname">
          </div>
          <div class="mb-3">
            <label class="form-label"> شماره تماس والدین خود را وارد کنید</label>
